...
const ResizableHandle = ({
  ...
  >
    {withHandle && (
      <div className="flex z-10 justify-center items-center w-3 h-4 rounded-sm border border-neutral-200 bg-neutral-200 dark:border-neutral-800 dark:bg-neutral-800">
